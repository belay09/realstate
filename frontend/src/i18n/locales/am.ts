...
export const am = {
  ...
  home: {
    ...
    partnersTitle: 'በብሌይ ላይ የሚወዳደሩ አልሚዎች',
    partnersDescription:
    ...
    credibilityDescription:
      'አያት እና ቴመር እያንዳቸው የራሳቸውን ፕሮጀክቶች ይለቀቃሉ። ብሌይ ሁለቱን በአንድ ጣቢያ ለማወዳደር ይረዳዎታል።',
    ctaEyebrow: 'ያግኙን',
  ...
  temer: {
    ...
    hotlineLabel: 'ሆትላይ',
    body: 'ቴመር ፕሮፐርቲስ በሳርቤት፣ አዋሬ፣ አያት፣ ፒያሳ እና በአዲስ አበባ የቤት ንብረት ይሰራል። በብሌይ ዝርዝሮችን ያስሱና ይጠይቁ፤ ግዢ ከቴመር ጋር ይቆያል።',
    browseTemer: 'የቴመር ቤቶችን እዚህ ያስሱ',
    officialSite: 'የቴመር ኦፊሴላዊ ድረ-ገጽ ↗',
    hotline: 'የቴመር ሽያጭ ሆትላይ {{hotline}}',
    highlights: [
      'ሳርቤት ሲቲ ፕላስ እና ብሉ ፖይንት',
      'አዋሬ እና አያት አካባቢ',
      'አዲስ አበባ · ለመጠየቅ ብሌይን ያግኙ',
    ],
  ...
  calculator: {
    ...
    priceAfterDiscount: 'የመጨረሻ አመልካች ዋጋ',
